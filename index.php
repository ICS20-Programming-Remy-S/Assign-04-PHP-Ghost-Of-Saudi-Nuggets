...
<html lang="en-ca">
 ...
 <label for="userNuggets">Nugget options:</label>
        <select name="Nugget options" id="userNuggets">
  ...
  <option value="20pcs nugget">20pcs nugget($11.99)</option>
        ...
        <input type="number" id="userMain" placeholder="ex.4" step="1" min="1"><br><br>
        
        <label for="userDrink">Drink options:</label>
        <select name="Drink options" id="userDrink">
  ...
  <option value="Large Drink">Large Drink($3.00)</option>
        ...
        <input type="number" id="userSide1" placeholder="ex.6" step="1" min="0"><br><br>
        
        <label for="userFries">Fries options:</label>
        <select name="fries options" id="userFries">
  ...
  <option value="large fries">Large fries($2.50)</option>
        ...
        <input type="number" id="userSide2" placeholder="ex.2" step="1" min="0"><br><br>

        <label for="userSauce">Sauce options:</label>
        <select name="Sauce options" id="userSauce">
  ...
  <option value="Honey">Honey($0.10)</option>
        ...
        <input type="number" id="sauceAmount" placeholder="ex.6" step="1" min="0"><br><br>
